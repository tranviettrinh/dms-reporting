...
file_path = '/Users/trinh/Desktop/Abipha/abipha_dms/api_misa/project/modules/'+file+'/CRM_Returnsale.xlsx'
...
print("Số dòng thiếu thông tin bắt buộc ListReturnPurchaseOrder:", len(invalid_rows))
input()
