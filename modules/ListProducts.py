...
list_products_DD =[] # thuốc đông dược
list_products_TD=[] # thuốc tân dược
for product in list_products:
	print(product)
	if product.get('category') =="NHÓM THUỐC ĐÔNG DƯỢC":
		list_products_DD.append(product.get('product_id'))
	elif product.get('category') =="NHÓM THUỐC TÂN DƯỢC":
		list_products_TD.append(product.get('product_id'))
